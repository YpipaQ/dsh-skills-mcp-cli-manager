window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:G:\Git_hub项目管理区\my-dsh-plugin\plugins\dsh-skills-mcp-manager\src\client\settings-card.module.css.mjs
		const css = ".Pox78G_card{background:#8080800d;border:1px solid #80808047;border-radius:8px;list-style:none;overflow:hidden}.Pox78G_header{width:100%;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;justify-content:space-between;align-items:center;gap:10px;padding:12px 14px;display:flex}.Pox78G_header:hover{background:#80808014}.Pox78G_headText{flex-direction:column;gap:3px;min-width:0;display:flex}.Pox78G_name{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-weight:600;overflow:hidden}.Pox78G_description{color:gray;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:1.35;overflow:hidden}.Pox78G_chevron,.Pox78G_chevronOpen{color:gray;flex:none;font-size:13px;transition:transform .12s}.Pox78G_chevronOpen{transform:rotate(180deg)}.Pox78G_body{border-top:1px solid #80808033;flex-direction:column;gap:16px;padding:14px;display:flex}.Pox78G_notExposed,.Pox78G_readOnly,.Pox78G_note{color:gray;font-size:12px}.Pox78G_error{color:#e5534b;font-size:12px}.Pox78G_config{flex-direction:column;gap:10px;display:flex}.Pox78G_field{flex-direction:column;gap:3px;display:flex}.Pox78G_toggle{cursor:pointer;align-items:center;gap:8px;display:flex}.Pox78G_toggle input{cursor:pointer}.Pox78G_toggleLabel{font-size:13px;font-weight:600}.Pox78G_hint{color:gray;margin:0;font-size:12px}.Pox78G_sectionPage{flex-direction:column;gap:12px;display:flex}.Pox78G_pageHeading{margin:0;font-size:16px;font-weight:600}.Pox78G_pageIntro{color:gray;margin:0;font-size:13px}.Pox78G_manager{flex-direction:column;gap:14px;display:flex}.Pox78G_tabs{border-bottom:1px solid #80808040;gap:4px;display:flex}.Pox78G_tab,.Pox78G_tabActive{cursor:pointer;font:inherit;color:inherit;opacity:.7;background:0 0;border:none;border-bottom:2px solid #0000;padding:8px 14px}.Pox78G_tabActive{opacity:1;border-bottom-color:currentColor;font-weight:600}.Pox78G_disabledBanner{color:#e5534b;border:1px solid #e5534b66;border-radius:8px;margin:0;padding:8px 10px;font-size:12px}.Pox78G_panel{flex-direction:column;gap:20px;display:flex}.Pox78G_section{flex-direction:column;gap:10px;display:flex}.Pox78G_h{margin:0;font-size:14px;font-weight:600}.Pox78G_hGrow{flex:auto;margin:0;font-size:14px;font-weight:600}.Pox78G_groupH{margin:10px 0 0;font-size:13px;font-weight:600}.Pox78G_inline{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.Pox78G_row{border:1px solid #80808033;border-radius:8px;align-items:center;gap:10px;padding:8px 10px;display:flex}.Pox78G_main{flex:auto;min-width:0}.Pox78G_desc{color:gray;text-overflow:ellipsis;white-space:nowrap;margin-top:2px;font-size:12px;overflow:hidden}.Pox78G_badge{white-space:nowrap;background:#80808026;border-radius:999px;padding:1px 8px;font-size:11px}.Pox78G_status{color:gray;font-size:11px}.Pox78G_switch{white-space:nowrap;align-items:center;gap:6px;font-size:12px;display:flex}.Pox78G_switch input{cursor:pointer}.Pox78G_btn{font:inherit;color:inherit;cursor:pointer;white-space:nowrap;background:0 0;border:1px solid #80808059;border-radius:6px;padding:4px 10px;font-size:12px}.Pox78G_btn:hover{background:#8080801a}.Pox78G_btn:disabled{opacity:.5;cursor:default}.Pox78G_btnActive{background:#80808026}.Pox78G_btnPrimary{border-color:currentColor;font-weight:600}.Pox78G_btnDanger{color:#e5534b;border-color:#e5534b66}.Pox78G_detail{background:#8080800a;border:1px solid #80808026;border-radius:8px;margin:4px 0 0;padding:10px}.Pox78G_pre{white-space:pre-wrap;word-break:break-word;background:#80808014;border-radius:6px;max-height:320px;margin:8px 0 0;padding:8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px;overflow:auto}.Pox78G_scanList{flex-direction:column;gap:8px;display:flex}.Pox78G_input,.Pox78G_inputGrow,.Pox78G_inputMono{font:inherit;color:inherit;box-sizing:border-box;background:0 0;border:1px solid #80808059;border-radius:6px;width:100%;padding:6px 8px;font-size:13px}.Pox78G_inputGrow{flex:auto;width:auto;min-width:240px}.Pox78G_inputMono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.Pox78G_filterSelect{font:inherit;color:inherit;background:0 0;border:1px solid #80808059;border-radius:6px;flex:none;width:auto;padding:6px 8px;font-size:13px}textarea.Pox78G_input{resize:vertical}.Pox78G_form{flex-direction:column;gap:10px;display:flex}.Pox78G_fieldLabel{flex-direction:column;gap:4px;display:flex}.Pox78G_fieldName{color:gray;font-size:12px}";
		const tagId = "@zebbkira/dsh-skills-mcp-manager/settings-card.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@zebbkira/dsh-skills-mcp-manager";
		...
		var settings_card_module_css_default = {
			...
			"body": "Pox78G_body",
			"btn": "Pox78G_btn",
			"btnActive": "Pox78G_btnActive",
			"btnDanger": "Pox78G_btnDanger",
			"btnPrimary": "Pox78G_btnPrimary",
			"card": "Pox78G_card",
			"chevron": "Pox78G_chevron",
			"chevronOpen": "Pox78G_chevronOpen",
			"config": "Pox78G_config",
			"desc": "Pox78G_desc",
			"description": "Pox78G_description",
			"detail": "Pox78G_detail",
			"disabledBanner": "Pox78G_disabledBanner",
			"error": "Pox78G_error",
			"field": "Pox78G_field",
			"fieldLabel": "Pox78G_fieldLabel",
			"fieldName": "Pox78G_fieldName",
			"filterSelect": "Pox78G_filterSelect",
			"form": "Pox78G_form",
			"groupH": "Pox78G_groupH",
			"h": "Pox78G_h",
			"hGrow": "Pox78G_hGrow",
			"headText": "Pox78G_headText",
			"header": "Pox78G_header",
			"hint": "Pox78G_hint",
			"inline": "Pox78G_inline",
			"input": "Pox78G_input",
			"inputGrow": "Pox78G_inputGrow",
			"inputMono": "Pox78G_inputMono",
			"main": "Pox78G_main",
			"manager": "Pox78G_manager",
			"name": "Pox78G_name",
			"notExposed": "Pox78G_notExposed",
			"note": "Pox78G_note",
			"pageHeading": "Pox78G_pageHeading",
			"pageIntro": "Pox78G_pageIntro",
			"panel": "Pox78G_panel",
			"pre": "Pox78G_pre",
			"readOnly": "Pox78G_readOnly",
			"row": "Pox78G_row",
			"scanList": "Pox78G_scanList",
			"section": "Pox78G_section",
			"sectionPage": "Pox78G_sectionPage",
			"status": "Pox78G_status",
			"switch": "Pox78G_switch",
			"tab": "Pox78G_tab",
			"tabActive": "Pox78G_tabActive",
			"tabs": "Pox78G_tabs",
			"toggle": "Pox78G_toggle",
			"toggleLabel": "Pox78G_toggleLabel"
		};
		//#endregion
